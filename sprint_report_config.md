...
| 2   | Remaining on hours tables (Stories / Tasks)                                                                | **Implemented** — Remaining (h) column from Jira remaining estimate                        |
| 3   | Separate Planned vs Capacity / Remaining vs Capacity table                                                 | **Dropped** — remaining lives on the hours tables instead                                  |
